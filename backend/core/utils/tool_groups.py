    ...
    "memories_tool": ToolGroup(
        ...
        methods=[
            ToolMethod(
                ...
                description="Upload and analyze videos from YouTube, TikTok, Instagram, or direct URLs",
                enabled=True
            ),
            ToolMethod(
            ...
            ToolMethod(
                ...
                description="Compare multiple videos for patterns and differences",
                enabled=True
            ),
            ToolMethod(
                name="multi_video_search",
                display_name="Multi-Video Search",
            ...
            ToolMethod(
                ...
                description="Analyze TikTok/Instagram/YouTube creator accounts and content strategy",
                enabled=True
            ),
            ToolMethod(
                name="analyze_trend",
