...
class Configuration:
    ...
    OR_APP_NAME: Optional[str] = "Adentic AI"    
    ...
    # Memories.ai configuration for video intelligence
    ...
    def _generate_admin_api_key(self) -> str:
        """Generate a secure admin API key for Adentic administrative functions."""
