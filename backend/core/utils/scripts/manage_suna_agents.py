...
Usage:
    # 🚀 MAIN COMMANDS
    python manage_suna_agents.py install-all          # Install Adentic for all users who don't have it
    python manage_suna_agents.py stats                # Show Adentic agent statistics
    python manage_suna_agents.py install-user <id>    # Install Adentic for specific user
...
class AdenticAgentManager:
    ...
    async def update_config_info(self):
        ...
        print("💡 To update Adentic behavior, simply modify backend/agent/suna/config.py")
