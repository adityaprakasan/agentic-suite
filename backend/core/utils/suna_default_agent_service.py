...
class SunaDefaultAgentService:
    ...
    async def _create_suna_agent_for_user(self, account_id: str) -> str:
        """Create the default Adentic agent for a user."""
        from core.suna_config import ADENTIC_CONFIG
    ...
    async def _create_initial_version(self, agent_id: str, account_id: str) -> None:
        ...
        try:
            ...
            await version_service.create_version(
                ...
                configured_mcps=ADENTIC_CONFIG["configured_mcps"],
                custom_mcps=ADENTIC_CONFIG["custom_mcps"],
                agentpress_tools=ADENTIC_CONFIG["agentpress_tools"],
