...
import { AdenticLogo } from '../sidebar/kortix-logo';
...
const dashboardTourSteps: Step[] = [
  {
    ...
    content: 'Type your questions or tasks here. Adentic can help with research, analysis, automation, and much more.',
...
export function DashboardContent() {
  ...
  const selectedAgent = selectedAgentId
    ...
    : null;
  const displayName = selectedAgent?.name || 'Adentic';
  const agentAvatar = undefined;
  const isAdenticAgent = selectedAgent?.metadata?.is_suna_default || false;
