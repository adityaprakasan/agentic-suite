...
const defaultRegistry: ToolViewRegistryType = {
  ...
  'upload-creator-videos': MemoriesToolView,
  'upload_hashtag_videos': MemoriesToolView,
  'upload-hashtag-videos': MemoriesToolView,
  'chat_with_videos': MemoriesToolView,
  'chat-with-videos': MemoriesToolView,
