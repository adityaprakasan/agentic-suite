...
const defaultRegistry: ToolViewRegistryType = {
  ...
  // Memories.ai video intelligence tools (support both - and _ formats)
  'upload_video': MemoriesToolView,
  'upload-video': MemoriesToolView,
  'upload_video_file': MemoriesToolView,
  'upload-video-file': MemoriesToolView,
  'search_platform_videos': MemoriesToolView,
  'search-platform-videos': MemoriesToolView,
  'query_video': MemoriesToolView,
  'query-video': MemoriesToolView,
  'ask_video': MemoriesToolView,
  'ask-video': MemoriesToolView,
  'get_transcript': MemoriesToolView,
  'get-transcript': MemoriesToolView,
  'analyze_creator': MemoriesToolView,
  'analyze-creator': MemoriesToolView,
  'analyze_trend': MemoriesToolView,
  'analyze-trend': MemoriesToolView,
  'check_task_status': MemoriesToolView,
  'check-task-status': MemoriesToolView,
  'search_trending_content': MemoriesToolView,
  'search-trending-content': MemoriesToolView,
  'chat_with_media': MemoriesToolView,
  'chat-with-media': MemoriesToolView,
  ...
  'list-video-chat-sessions': MemoriesToolView,
  'list_chat_sessions': MemoriesToolView,
  'list-chat-sessions': MemoriesToolView,
  'get_session_history': MemoriesToolView,
  'get-session-history': MemoriesToolView,
  'get_video_details': MemoriesToolView,
  'get-video-details': MemoriesToolView,
  'download_video_file': MemoriesToolView,
  'download-video-file': MemoriesToolView,
  'update_transcription': MemoriesToolView,
  'update-transcription': MemoriesToolView,
  'get_audio_transcript': MemoriesToolView,
  'get-audio-transcript': MemoriesToolView,
  'list_my_images': MemoriesToolView,
  'list-my-images': MemoriesToolView,
  'search_audio': MemoriesToolView,
  'search-audio': MemoriesToolView,
