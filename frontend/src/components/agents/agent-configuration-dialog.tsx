                              ...
                              {agents.map((agent: any) => (
                                ...
                                >
                                  <AgentAvatar
                                    ...
                                    isAdenticDefault={agent.metadata?.is_suna_default}
                                    size={24}
                                    className="flex-shrink-0"
                                  />
                    ...
                    {isAdenticAgent && (
                      <Alert className="mb-4 bg-blue-50 border-blue-200 dark:bg-blue-950/20 dark:border-blue-900">
                        ...
                        <AlertDescription className="text-sm text-blue-800 dark:text-blue-300">
                          You can't edit the main Adentic Marketing Assistant, but you can create a new marketing assistant that you can modify as you wish.
                        </AlertDescription>
                      </Alert>
                    )}
